...
export class Constructions extends THREE.Group {
  ...
  private static hauteurParEtage = 18.4 / 6;
  ...
  constructor() {
    ...
    this.uni = createExtrudedPolygon(dUni, 0xF08885, Constructions.hauteurParEtage * Constructions.nbdetages * Constructions.ratio);
  ...
  update() {
    this.uni.scale.z = Constructions.nbdetages / 6;
    this.uni.position.y = Constructions.hauteurParEtage * Constructions.nbdetages * Constructions.ratio;
  }
}
