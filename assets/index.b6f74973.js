...
}`;function ke(h){const e=document.createElement("style");e.innerHTML=h;const i=document.querySelector("head link[rel=stylesheet], head style");i?document.head.insertBefore(e,i):document.head.appendChild(e)}let Gt=!1;class It{constructor({parent:e,autoPlace:i=e===void 0,container:t,width:s,title:o="Controls",injectStyles:a=!0,touchStyles:r=!0}={}){if(this.parent=e,this.root=e?e.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",A=>{(A.code==="Enter"||A.code==="Space")&&(A.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(o),r&&this.domElement.classList.add("allow-touch-styles"),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),!Gt&&a&&(ke(Pe),Gt=!0),t?t.appendChild(this.domElement):i&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),s&&this.domElement.style.setProperty("--width",s+"px"),this.domElement.addEventListener("keydown",A=>A.stopPropagation()),this.domElement.addEventListener("keyup",A=>A.stopPropagation())}add(e,i,t,s,o){if(Object(t)===t)return new Ce(this,e,i,t);const a=e[i];switch(typeof a){case"number":return new Le(this,e,i,t,s,o);case"boolean":return new ve(this,e,i);case"string":return new Se(this,e,i);case"function":return new Pt(this,e,i)}console.error(`gui.add failed
	property:`,i,`
	object:`,e,`
	value:`,a)}addColor(e,i,t=1){return new Me(this,e,i,t)}addFolder(e){return new It({parent:this,title:e})}load(e,i=!0){return e.controllers&&this.controllers.forEach(t=>{t instanceof Pt||t._name in e.controllers&&t.load(e.controllers[t._name])}),i&&e.folders&&this.folders.forEach(t=>{t._title in e.folders&&t.load(e.folders[t._title])}),this}save(e=!0){const i={controllers:{},folders:{}};return this.controllers.forEach(t=>{if(!(t instanceof Pt)){if(t._name in i.controllers)throw new Error(`Cannot save GUI with duplicate property "${t._name}"`);i.controllers[t._name]=t.save()}}),e&&this.folders.forEach(t=>{if(t._title in i.folders)throw new Error(`Cannot save GUI with duplicate folder "${t._title}"`);i.folders[t._title]=t.save()}),i}open(e=!0){return this._closed=!e,this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}show(e=!0){return this._hidden=!e,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(e=!0){return this._closed=!e,this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const i=this.$children.clientHeight;this.$children.style.height=i+"px",this.domElement.classList.add("transition");const t=o=>{o.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",t))};this.$children.addEventListener("transitionend",t);const s=e?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!e),requestAnimationFrame(()=>{this.$children.style.height=s+"px"})}),this}title(e){return this._title=e,this.$title.innerHTML=e,this}reset(e=!0){return(e?this.controllersRecursive():this.controllers).forEach(t=>t.reset()),this}onChange(e){return this._onChange=e,this}_callOnChange(e){this.parent&&this.parent._callOnChange(e),this._onChange!==void 0&&this._onChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}onFinishChange(e){return this._onFinishChange=e,this}_callOnFinishChange(e){this.parent&&this.parent._callOnFinishChange(e),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:e.object,property:e.property,value:e.getValue(),controller:e})}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(e=>e.destroy())}controllersRecursive(){let e=Array.from(this.controllers);return this.folders.forEach(i=>{e=e.concat(i.controllersRecursive())}),e}foldersRecursive(){let e=Array.from(this.folders);return this.folders.forEach(i=>{e=e.concat(i.foldersRecursive())}),e}}var vt=function(){var h=0,e=document.createElement("div");e.style.cssText="position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000",e.addEventListener("click",function(d){d.preventDefault(),t(++h%e.children.length)},!1);function i(d){return e.appendChild(d.dom),d}function t(d){for(var v=0;v<e.children.length;v++)e.children[v].style.display=v===d?"block":"none";h=d}var s=(performance||Date).now(),o=s,a=0,r=i(new vt.Panel("FPS","#0ff","#002")),A=i(new vt.Panel("MS","#0f0","#020"));if(self.performance&&self.performance.memory)var m=i(new vt.Panel("MB","#f08","#201"));return t(0),{REVISION:16,dom:e,addPanel:i,showPanel:t,begin:function(){s=(performance||Date).now()},end:function(){a++;var d=(performance||Date).now();if(A.update(d-s,200),d>=o+1e3&&(r.update(a*1e3/(d-o),100),o=d,a=0,m)){var v=performance.memory;m.update(v.usedJSHeapSize/1048576,v.jsHeapSizeLimit/1048576)}return d},update:function(){s=this.end()},domElement:e,setMode:t}};vt.Panel=function(h,e,i){var t=1/0,s=0,o=Math.round,a=o(window.devicePixelRatio||1),r=80*a,A=48*a,m=3*a,d=2*a,v=3*a,f=15*a,M=74*a,E=30*a,x=document.createElement("canvas");x.width=r,x.height=A,x.style.cssText="width:80px;height:48px";var g=x.getContext("2d");return g.font="bold "+9*a+"px Helvetica,Arial,sans-serif",g.textBaseline="top",g.fillStyle=i,g.fillRect(0,0,r,A),g.fillStyle=e,g.fillText(h,m,d),g.fillRect(v,f,M,E),g.fillStyle=i,g.globalAlpha=.9,g.fillRect(v,f,M,E),{dom:x,update:function(l,L){t=Math.min(t,l),s=Math.max(s,l),g.fillStyle=i,g.globalAlpha=1,g.fillRect(0,0,r,f),g.fillStyle=e,g.fillText(o(l)+" "+h+" ("+o(t)+"-"+o(s)+")",m,d),g.drawImage(x,v+a,f,M-a,E,v,f,M-a,E),g.fillRect(v+M-a,f,a,E),g.fillStyle=i,g.globalAlpha=.9,g.fillRect(v+M-a,f,a,o((1-l/L)*E))}}};const Xt={type:"change"},kt={type:"start"},Dt={type:"end"};class De extends oe{constructor(e,i){super(),i===void 0&&console.warn('THREE.OrbitControls: The second parameter "domElement" is now mandatory.'),i===document&&console.error('THREE.OrbitControls: "document" should not be used as the target "domElement". Please use "renderer.domElement" instead.'),this.object=e,this.domElement=i,this.domElement.style.touchAction="none",this.enabled=!0,this.target=new J,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:ft.ROTATE,MIDDLE:ft.DOLLY,RIGHT:ft.PAN},this.touches={ONE:gt.ROTATE,TWO:gt.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this.getPolarAngle=function(){return r.phi},this.getAzimuthalAngle=function(){return r.theta},this.getDistance=function(){return this.object.position.distanceTo(this.target)},this.listenToKeyEvents=function(n){n.addEventListener("keydown",ct),this._domElementKeyEvents=n},this.saveState=function(){t.target0.copy(t.target),t.position0.copy(t.object.position),t.zoom0=t.object.zoom},this.reset=function(){t.target.copy(t.target0),t.object.position.copy(t.position0),t.object.zoom=t.zoom0,t.object.updateProjectionMatrix(),t.dispatchEvent(Xt),t.update(),o=s.NONE},this.update=function(){const n=new J,p=new Yt().setFromUnitVectors(e.up,new J(0,1,0)),F=p.clone().invert(),z=new J,et=new Yt,mt=2*Math.PI;return function(){const Vt=t.object.position;n.copy(Vt).sub(t.target),n.applyQuaternion(p),r.setFromVector3(n),t.autoRotate&&o===s.NONE&&k(dt()),t.enableDamping?(r.theta+=A.theta*t.dampingFactor,r.phi+=A.phi*t.dampingFactor):(r.theta+=A.theta,r.phi+=A.phi);let ot=t.minAzimuthAngle,at=t.maxAzimuthAngle;return isFinite(ot)&&isFinite(at)&&(ot<-Math.PI?ot+=mt:ot>Math.PI&&(ot-=mt),at<-Math.PI?at+=mt:at>Math.PI&&(at-=mt),ot<=at?r.theta=Math.max(ot,Math.min(at,r.theta)):r.theta=r.theta>(ot+at)/2?Math.max(ot,r.theta):Math.min(at,r.theta)),r.phi=Math.max(t.minPolarAngle,Math.min(t.maxPolarAngle,r.phi)),r.makeSafe(),r.radius*=m,r.radius=Math.max(t.minDistance,Math.min(t.maxDistance,r.radius)),t.enableDamping===!0?t.target.addScaledVector(d,t.dampingFactor):t.target.add(d),n.setFromSpherical(r),n.applyQuaternion(F),Vt.copy(t.target).add(n),t.object.lookAt(t.target),t.enableDamping===!0?(A.theta*=1-t.dampingFactor,A.phi*=1-t.dampingFactor,d.multiplyScalar(1-t.dampingFactor)):(A.set(0,0,0),d.set(0,0,0)),m=1,v||z.distanceToSquared(t.object.position)>a||8*(1-et.dot(t.object.quaternion))>a?(t.dispatchEvent(Xt),z.copy(t.object.position),et.copy(t.object.quaternion),v=!1,!0):!1}}(),this.dispose=function(){t.domElement.removeEventListener("contextmenu",Nt),t.domElement.removeEventListener("pointerdown",X),t.domElement.removeEventListener("pointercancel",W),t.domElement.removeEventListener("wheel",Y),t.domElement.removeEventListener("pointermove",U),t.domElement.removeEventListener("pointerup",it),t._domElementKeyEvents!==null&&t._domElementKeyEvents.removeEventListener("keydown",ct)};const t=this,s={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let o=s.NONE;const a=1e-6,r=new jt,A=new jt;let m=1;const d=new J;let v=!1;const f=new K,M=new K,E=new K,x=new K,g=new K,l=new K,L=new K,T=new K,j=new K,y=[],w={};function dt(){return 2*Math.PI/60/60*t.autoRotateSpeed}function q(){return Math.pow(.95,t.zoomSpeed)}function k(n){A.theta-=n}function _(n){A.phi-=n}const I=function(){const n=new J;return function(F,z){n.setFromMatrixColumn(z,0),n.multiplyScalar(-F),d.add(n)}}(),N=function(){const n=new J;return function(F,z){t.screenSpacePanning===!0?n.setFromMatrixColumn(z,1):(n.setFromMatrixColumn(z,0),n.crossVectors(t.object.up,n)),n.multiplyScalar(F),d.add(n)}}(),V=function(){const n=new J;return function(F,z){const et=t.domElement;if(t.object.isPerspectiveCamera){const mt=t.object.position;n.copy(mt).sub(t.target);let _t=n.length();_t*=Math.tan(t.object.fov/2*Math.PI/180),I(2*F*_t/et.clientHeight,t.object.matrix),N(2*z*_t/et.clientHeight,t.object.matrix)}else t.object.isOrthographicCamera?(I(F*(t.object.right-t.object.left)/t.object.zoom/et.clientWidth,t.object.matrix),N(z*(t.object.top-t.object.bottom)/t.object.zoom/et.clientHeight,t.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),t.enablePan=!1)}}();function ut(n){t.object.isPerspectiveCamera?m/=n:t.object.isOrthographicCamera?(t.object.zoom=Math.max(t.minZoom,Math.min(t.maxZoom,t.object.zoom*n)),t.object.updateProjectionMatrix(),v=!0):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),t.enableZoom=!1)}function bt(n){t.object.isPerspectiveCamera?m*=n:t.object.isOrthographicCamera?(t.object.zoom=Math.max(t.minZoom,Math.min(t.maxZoom,t.object.zoom/n)),t.object.updateProjectionMatrix(),v=!0):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),t.enableZoom=!1)}function At(n){f.set(n.clientX,n.clientY)}function Ct(n){L.set(n.clientX,n.clientY)}function Et(n){x.set(n.clientX,n.clientY)}function xt(n){M.set(n.clientX,n.clientY),E.subVectors(M,f).multiplyScalar(t.rotateSpeed);const p=t.domElement;k(2*Math.PI*E.x/p.clientHeight),_(2*Math.PI*E.y/p.clientHeight),f.copy(M),t.update()}function pt(n){T.set(n.clientX,n.clientY),j.subVectors(T,L),j.y>0?ut(q()):j.y<0&&bt(q()),L.copy(T),t.update()}function c(n){g.set(n.clientX,n.clientY),l.subVectors(g,x).multiplyScalar(t.panSpeed),V(l.x,l.y),x.copy(g),t.update()}function u(n){n.deltaY<0?bt(q()):n.deltaY>0&&ut(q()),t.update()}function b(n){let p=!1;switch(n.code){case t.keys.UP:V(0,t.keyPanSpeed),p=!0;break;case t.keys.BOTTOM:V(0,-t.keyPanSpeed),p=!0;break;case t.keys.LEFT:V(t.keyPanSpeed,0),p=!0;break;case t.keys.RIGHT:V(-t.keyPanSpeed,0),p=!0;break}p&&(n.preventDefault(),t.update())}function P(){if(y.length===1)f.set(y[0].pageX,y[0].pageY);else{const n=.5*(y[0].pageX+y[1].pageX),p=.5*(y[0].pageY+y[1].pageY);f.set(n,p)}}function C(){if(y.length===1)x.set(y[0].pageX,y[0].pageY);else{const n=.5*(y[0].pageX+y[1].pageX),p=.5*(y[0].pageY+y[1].pageY);x.set(n,p)}}function $(){const n=y[0].pageX-y[1].pageX,p=y[0].pageY-y[1].pageY,F=Math.sqrt(n*n+p*p);L.set(0,F)}function S(){t.enableZoom&&$(),t.enablePan&&C()}function O(){t.enableZoom&&$(),t.enableRotate&&P()}function R(n){if(y.length==1)M.set(n.pageX,n.pageY);else{const F=St(n),z=.5*(n.pageX+F.x),et=.5*(n.pageY+F.y);M.set(z,et)}E.subVectors(M,f).multiplyScalar(t.rotateSpeed);const p=t.domElement;k(2*Math.PI*E.x/p.clientHeight),_(2*Math.PI*E.y/p.clientHeight),f.copy(M)}function B(n){if(y.length===1)g.set(n.pageX,n.pageY);else{const p=St(n),F=.5*(n.pageX+p.x),z=.5*(n.pageY+p.y);g.set(F,z)}l.subVectors(g,x).multiplyScalar(t.panSpeed),V(l.x,l.y),x.copy(g)}function G(n){const p=St(n),F=n.pageX-p.x,z=n.pageY-p.y,et=Math.sqrt(F*F+z*z);T.set(0,et),j.set(0,Math.pow(T.y/L.y,t.zoomSpeed)),ut(j.y),L.copy(T)}function Q(n){t.enableZoom&&G(n),t.enablePan&&B(n)}function st(n){t.enableZoom&&G(n),t.enableRotate&&R(n)}function X(n){t.enabled!==!1&&(y.length===0&&(t.domElement.setPointerCapture(n.pointerId),t.domElement.addEventListener("pointermove",U),t.domElement.addEventListener("pointerup",it)),se(n),n.pointerType==="touch"?ee(n):Z(n))}function U(n){t.enabled!==!1&&(n.pointerType==="touch"?ie(n):tt(n))}function it(n){t.enabled!==!1&&(n.pointerType==="touch"?ne():lt(),Rt(n),y.length===0&&(t.domElement.releasePointerCapture(n.pointerId),t.domElement.removeEventListener("pointermove",U),t.domElement.removeEventListener("pointerup",it)))}function W(n){Rt(n)}function Z(n){let p;switch(n.button){case 0:p=t.mouseButtons.LEFT;break;case 1:p=t.mouseButtons.MIDDLE;break;case 2:p=t.mouseButtons.RIGHT;break;default:p=-1}switch(p){case ft.DOLLY:if(t.enableZoom===!1)return;Ct(n),o=s.DOLLY;break;case ft.ROTATE:if(n.ctrlKey||n.metaKey||n.shiftKey){if(t.enablePan===!1)return;Et(n),o=s.PAN}else{if(t.enableRotate===!1)return;At(n),o=s.ROTATE}break;case ft.PAN:if(n.ctrlKey||n.metaKey||n.shiftKey){if(t.enableRotate===!1)return;At(n),o=s.ROTATE}else{if(t.enablePan===!1)return;Et(n),o=s.PAN}break;default:o=s.NONE}o!==s.NONE&&t.dispatchEvent(kt)}function tt(n){if(t.enabled!==!1)switch(o){case s.ROTATE:if(t.enableRotate===!1)return;xt(n);break;case s.DOLLY:if(t.enableZoom===!1)return;pt(n);break;case s.PAN:if(t.enablePan===!1)return;c(n);break}}function lt(n){t.dispatchEvent(Dt),o=s.NONE}function Y(n){t.enabled===!1||t.enableZoom===!1||o!==s.NONE||(n.preventDefault(),t.dispatchEvent(kt),u(n),t.dispatchEvent(Dt))}function ct(n){t.enabled===!1||t.enablePan===!1||b(n)}function ee(n){switch(zt(n),y.length){case 1:switch(t.touches.ONE){case gt.ROTATE:if(t.enableRotate===!1)return;P(),o=s.TOUCH_ROTATE;break;case gt.PAN:if(t.enablePan===!1)return;C(),o=s.TOUCH_PAN;break;default:o=s.NONE}break;case 2:switch(t.touches.TWO){case gt.DOLLY_PAN:if(t.enableZoom===!1&&t.enablePan===!1)return;S(),o=s.TOUCH_DOLLY_PAN;break;case gt.DOLLY_ROTATE:if(t.enableZoom===!1&&t.enableRotate===!1)return;O(),o=s.TOUCH_DOLLY_ROTATE;break;default:o=s.NONE}break;default:o=s.NONE}o!==s.NONE&&t.dispatchEvent(kt)}function ie(n){switch(zt(n),o){case s.TOUCH_ROTATE:if(t.enableRotate===!1)return;R(n),t.update();break;case s.TOUCH_PAN:if(t.enablePan===!1)return;B(n),t.update();break;case s.TOUCH_DOLLY_PAN:if(t.enableZoom===!1&&t.enablePan===!1)return;Q(n),t.update();break;case s.TOUCH_DOLLY_ROTATE:if(t.enableZoom===!1&&t.enableRotate===!1)return;st(n),t.update();break;default:o=s.NONE}}function ne(n){t.dispatchEvent(Dt),o=s.NONE}function Nt(n){t.enabled!==!1&&n.preventDefault()}function se(n){y.push(n)}function Rt(n){delete w[n.pointerId];for(let p=0;p<y.length;p++)if(y[p].pointerId==n.pointerId){y.splice(p,1);return}}function zt(n){let p=w[n.pointerId];p===void 0&&(p=new K,w[n.pointerId]=p),p.set(n.pageX,n.pageY)}function St(n){const p=n.pointerId===y[0].pointerId?y[1]:y[0];return w[p.pointerId]}t.domElement.addEventListener("contextmenu",Nt),t.domElement.addEventListener("pointerdown",X),t.domElement.addEventListener("pointercancel",W),t.domElement.addEventListener("wheel",Y,{passive:!1}),this.update()}}const Te=Math.PI/180,Ut=48,Wt=57,Zt=44,Kt=32,$e=46,Jt=45;function Oe(h){const e=new ae;let i=1,t,s=0,o=0,a=0,r=0,A=null,m=null,d=0,v=0,f=0,M=0,E=0,x=0,g=0,l=0,L=0,T,j;const y=h.length;function w(){let k,_,I=!1,N;for(;i<y&&(_=h.charCodeAt(i),!(_!==Zt&&_!==Kt));)i++;for(_===Jt?k=i++:k=i;i<y;){if(_=h.charCodeAt(i),Ut<=_&&_<=Wt){i++;continue}else if(_===$e){i++,I=!0;continue}return N=h.substring(k,i),I?parseFloat(N):parseInt(N)}return N=h.substring(k),I?parseFloat(N):parseInt(N)}function dt(){let k;for(;i<y&&(k=h.charCodeAt(i),!(k!==Zt&&k!==Kt));)i++;return k=h.charCodeAt(i),k===Jt||Ut<=k&&k<=Wt}let q;for(t=h[0];i<=y;){switch(q=!0,t){case"M":s=w(),o=w(),e.moveTo(s,o),t="L",A=s,m=o;break;case"m":s+=w(),o+=w(),e.moveTo(s,o),t="l",A=s,m=o;break;case"Z":case"z":q=!1,(s!==A||o!==m)&&e.lineTo(A,m);break;case"L":case"H":case"V":a=t==="V"?s:w(),r=t==="H"?o:w(),e.lineTo(a,r),s=a,o=r;break;case"l":case"h":case"v":a=t==="v"?s:s+w(),r=t==="h"?o:o+w(),e.lineTo(a,r),s=a,o=r;break;case"C":d=w(),f=w();case"S":t==="S"&&(d=2*s-v,f=2*o-M),v=w(),M=w(),a=w(),r=w(),e.bezierCurveTo(d,f,v,M,a,r),s=a,o=r;break;case"c":d=s+w(),f=o+w();case"s":t==="s"&&(d=2*s-v,f=2*o-M),v=s+w(),M=o+w(),a=s+w(),r=o+w(),e.bezierCurveTo(d,f,v,M,a,r),s=a,o=r;break;case"Q":d=w(),f=w();case"T":t==="T"&&(d=2*s-d,f=2*o-f),a=w(),r=w(),e.quadraticCurveTo(d,f,a,r),s=a,o=r;break;case"q":d=s+w(),f=o+w();case"t":t==="t"&&(d=2*s-d,f=2*o-f),a=s+w(),r=o+w(),e.quadraticCurveTo(d,f,a,r),s=a,o=r;break;case"A":{E=w(),x=w(),g=w()*Te,l=w(),L=w(),a=w(),r=w(),E!==x&&console.warn("Forcing elliptical arc to be a circular one:",E,x),d=Math.cos(g)*(s-a)/2+Math.sin(g)*(o-r)/2,f=-Math.sin(g)*(s-a)/2+Math.cos(g)*(o-r)/2;let k=Math.sqrt((E*E*x*x-E*E*f*f-x*x*d*d)/(E*E*f*f+x*x*d*d));l===L&&(k=-k),v=k*E*f/x,M=k*-x*d/E,T=Math.cos(g)*v-Math.sin(g)*M+(s+a)/2,j=Math.sin(g)*v+Math.cos(g)*M+(o+r)/2;const _=new K(1,0),I=new K((d-v)/E,(f-M)/x);let N=Math.acos(_.dot(I)/_.length()/I.length());_.x*I.y-_.y*I.x<0&&(N=-N),_.x=(-d-v)/E,_.y=(-f-M)/x;let V=Math.acos(I.dot(_)/I.length()/_.length());I.x*_.y-I.y*_.x<0&&(V=-V),!L&&V>0&&(V-=Math.PI*2),L&&V<0&&(V+=Math.PI*2),e.absarc(T,j,E,N,N+V,L),s=a,o=r;break}default:throw new Error(`Wrong path command: ${t}`)}q&&dt()||(t=h[i++])}return e}function Mt(h,e,i,t){const s=Oe(h),o=new re({color:e}),a=s.toShapes(!0);for(let r=0;r<a.length;r++){const A=a[r],m=new le(A,{depth:i,bevelEnabled:!1});t?(t.geometry=m,t.material=o):t=new qt(m,o),t.rotation.x=Math.PI/2,t.translateZ(-i-1)}return t}const rt=class extends Ot{constructor(){super();const e=Mt("M -181.06303,168.32097 L -175.39989,86.992054 L -99.419491,85.261653 L -100.20604,94.228284 L -92.65519,101.80342 L -46.878179,103.19491 L -50.968219,158.88241 Z",5422675,.5);e.translateY(.4),e.receiveShadow=!0;const t=Mt("M -500,350 l 600,0 l 0,-600 l -600,0 Z",8421504,.1);t.receiveShadow=!0;const o=Mt("m -137.59706,98.776225 h 18.13122 v 11.012215 h 9.78864 v 10.67851 h 11.234678 v 14.46048 h -7.452708 v 14.68295 h -21.69073 v -15.35036 h 7.56395 v -13.12566 h -17.35258 z",11250603,3*rt.ratio);o.castShadow=!0,o.receiveShadow=!0;const a="M -300.2865,87.430307 H -287.87487 V 82.091053 L -280.3109,82.758459 L -282.31314,86.762901 L -263.12518,98.275671 L -260.78926,102.28011 L -261.12296,123.74837 L -270.74473,140.15545 L -278.3087,144.27113 L -265.62796,165.85062 L -235.87273,166.40679 L -224.02626,173.5258 L -211.01182,151.16767 L -229.58798,118.79843 V 113.79288 L -218.687,94.994253 L -209.89948,89.988701 L -214.01515,82.980928 L -210.90059,80.645004 L -216.12861,71.857478 L -222.13527,72.191183 L -222.02404,66.073286 L -257.17413,65.405878 L -261.95722,62.625017 L -272.96943,44.16009 L -272.41325,34.48269 L -281.20078,34.92763 L -280.97832,30.255781 L -293.32533,30.033312 L -293.2141,34.816393 L -300.2865,34.48269 Z";this.uni=Mt(a,15763589,rt.hauteurParEtage*rt.nbdetages*rt.ratio),this.uni.castShadow=!0,this.add(o,e,t,this.uni),this.position.set(50,0,-200),this.rotation.y=1.01}update(){this.uni.scale.z=rt.nbdetages/6,this.uni.position.y=rt.hauteurParEtage*rt.nbdetages*rt.ratio}};let ht=rt;ht.nbdetages=6;ht.hauteurParEtage=18.4/6;ht.ratio=31/14.4;var Qt={exports:{}};(function(h,e){(function(){var i=Math.PI,t=Math.sin,s=Math.cos,o=Math.tan,a=Math.asin,r=Math.atan2,A=Math.acos,m=i/180,d=1e3*60*60*24,v=2440588,f=2451545;function M(c){return c.valueOf()/d-.5+v}function E(c){return new Date((c+.5-v)*d)}function x(c){return M(c)-f}var g=m*23.4397;function l(c,u){return r(t(c)*s(g)-o(u)*t(g),s(c))}function L(c,u){return a(t(u)*s(g)+s(u)*t(g)*t(c))}function T(c,u,b){return r(t(c),s(c)*t(u)-o(b)*s(u))}function j(c,u,b){return a(t(u)*t(b)+s(u)*s(b)*s(c))}function y(c,u){return m*(280.16+360.9856235*c)-u}function w(c){return c<0&&(c=0),2967e-7/Math.tan(c+.00312536/(c+.08901179))}function dt(c){return m*(357.5291+.98560028*c)}function q(c){var u=m*(1.9148*t(c)+.02*t(2*c)+3e-4*t(3*c)),b=m*102.9372;return c+u+b+i}function k(c){var u=dt(c),b=q(u);return{dec:L(b,0),ra:l(b,0)}}var _={};_.getPosition=function(c,u,b){var P=m*-b,C=m*u,$=x(c),S=k($),O=y($,P)-S.ra;return{azimuth:T(O,C,S.dec),altitude:j(O,C,S.dec)}};var I=_.times=[[-.833,"sunrise","sunset"],[-.3,"sunriseEnd","sunsetStart"],[-6,"dawn","dusk"],[-12,"nauticalDawn","nauticalDusk"],[-18,"nightEnd","night"],[6,"goldenHourEnd","goldenHour"]];_.addTime=function(c,u,b){I.push([c,u,b])};var N=9e-4;function V(c,u){return Math.round(c-N-u/(2*i))}function ut(c,u,b){return N+(c+u)/(2*i)+b}function bt(c,u,b){return f+c+.0053*t(u)-.0069*t(2*b)}function At(c,u,b){return A((t(c)-t(u)*t(b))/(s(u)*s(b)))}function Ct(c){return-2.076*Math.sqrt(c)/60}function Et(c,u,b,P,C,$,S){var O=At(c,b,P),R=ut(O,u,C);return bt(R,$,S)}_.getTimes=function(c,u,b,P){P=P||0;var C=m*-b,$=m*u,S=Ct(P),O=x(c),R=V(O,C),B=ut(0,C,R),G=dt(B),Q=q(G),st=L(Q,0),X=bt(B,G,Q),U,it,W,Z,tt,lt,Y={solarNoon:E(X),nadir:E(X-.5)};for(U=0,it=I.length;U<it;U+=1)W=I[U],Z=(W[0]+S)*m,tt=Et(Z,C,$,st,R,G,Q),lt=X-(tt-X),Y[W[1]]=E(lt),Y[W[2]]=E(tt);return Y};function xt(c){var u=m*(218.316+13.176396*c),b=m*(134.963+13.064993*c),P=m*(93.272+13.22935*c),C=u+m*6.289*t(b),$=m*5.128*t(P),S=385001-20905*s(b);return{ra:l(C,$),dec:L(C,$),dist:S}}_.getMoonPosition=function(c,u,b){var P=m*-b,C=m*u,$=x(c),S=xt($),O=y($,P)-S.ra,R=j(O,C,S.dec),B=r(t(O),o(C)*s(S.dec)-t(S.dec)*s(O));return R=R+w(R),{azimuth:T(O,C,S.dec),altitude:R,distance:S.dist,parallacticAngle:B}},_.getMoonIllumination=function(c){var u=x(c||new Date),b=k(u),P=xt(u),C=149598e3,$=A(t(b.dec)*t(P.dec)+s(b.dec)*s(P.dec)*s(b.ra-P.ra)),S=r(C*t($),P.dist-C*s($)),O=r(s(b.dec)*t(b.ra-P.ra),t(b.dec)*s(P.dec)-s(b.dec)*t(P.dec)*s(b.ra-P.ra));return{fraction:(1+s(S))/2,phase:.5+.5*S*(O<0?-1:1)/Math.PI,angle:O}};function pt(c,u){return new Date(c.valueOf()+u*d/24)}_.getMoonTimes=function(c,u,b,P){var C=new Date(c);P?C.setUTCHours(0,0,0,0):C.setHours(0,0,0,0);for(var $=.133*m,S=_.getMoonPosition(C,u,b).altitude-$,O,R,B,G,Q,st,X,U,it,W,Z,tt,lt,Y=1;Y<=24&&(O=_.getMoonPosition(pt(C,Y),u,b).altitude-$,R=_.getMoonPosition(pt(C,Y+1),u,b).altitude-$,Q=(S+R)/2-O,st=(R-S)/2,X=-st/(2*Q),U=(Q*X+st)*X+O,it=st*st-4*Q*O,W=0,it>=0&&(lt=Math.sqrt(it)/(Math.abs(Q)*2),Z=X-lt,tt=X+lt,Math.abs(Z)<=1&&W++,Math.abs(tt)<=1&&W++,Z<-1&&(Z=tt)),W===1?S<0?B=Y+Z:G=Y+Z:W===2&&(B=Y+(U<0?tt:Z),G=Y+(U<0?Z:tt)),!(B&&G));Y+=2)S=R;var ct={};return B&&(ct.rise=pt(C,B)),G&&(ct.set=pt(C,G)),!B&&!G&&(ct[U>0?"alwaysUp":"alwaysDown"]=!0),ct},h.exports=_})()})(Qt);const H=class{static update(h){H.play&&(H.time+=(h-H.lastUpdateDelta)*H.timeSpeedMultiplier),H.lastUpdateDelta=h}static addOneMinute(){H.time+=6e4}static removeOneMinute(){H.time-=6e4}static addTenMinutes(){H.time+=6e5}static removeTenMinutes(){H.time-=6e5}static addOneHour(){H.time+=36e5}static removeOneHour(){H.time-=36e5}static addOneDay(){H.time+=864e5}static removeOneDay(){H.time-=864e5}static addTenDays(){H.time+=864e6}static removeTenDays(){H.time-=864e6}static addOneMonth(){H.time+=2592e6}static removeOneMonth(){H.time-=2592e6}};let D=H;D.lastUpdateDelta=0;D.timeSpeedMultiplier=5e3;D.play=!0;D.time=new Date(2022,0,1,1).getTime();const $t=class{static getPosition(){return Qt.exports.getPosition(new Date(D.time),$t.lat,$t.long)}};let Ft=$t;Ft.lat=46.089064115568284;Ft.long=6.107614109077571;class Ie extends he{constructor(){super(16777215,1,1e4),this.castShadow=!0}setNightMode(e){this.intensity=e?.1:1}}const Lt=class extends qt{constructor(){const h=new ce(10,16,8),e=new Bt({color:Lt.dayColor});super(h,e)}setNightMode(h){this.material=new Bt({color:h?Lt.nightColor:Lt.dayColor})}};let Ht=Lt;Ht.nightColor=8947712;Ht.dayColor=16776960;class Fe extends Ot{constructor(){super(),this.isNight=!1,this.light=new Ie,this.add(this.light),this.sphere=new Ht,this.add(this.sphere),this.updatePosition()}updatePosition(){const e=Ft.getPosition();e.azimuth+=Math.PI/2,e.altitude+=Math.PI/2;const i=450,t=i*Math.sin(e.altitude),s=t*Math.cos(e.azimuth),o=t*Math.sin(e.azimuth),a=i*Math.cos(e.altitude);this.position.set(s,-a,o);const r=this.position.y<0;r!==this.isNight&&(this.sphere.setNightMode(r),this.light.setNightMode(r),this.isNight=r)}}class He{constructor(){this.stoppedByFocus=!1;const e=document.createElement("div");Object.assign(e.style,{position:"absolute",top:"10px",width:"100%",textAlign:"center",zIndex:"100",display:"block",color:"#00e6e6"}),this.dateInput=document.createElement("input"),this.dateInput.type="datetime-local",Object.assign(this.dateInput.style,{width:"200px",height:"30px",fontSize:"16px",textAlign:"center",color:"#00e6e6",backgroundColor:"#333",border:"none",borderRadius:"3px",borderBottom:"1px solid #00e6e6"}),this.updateDateInputValue(),this.dateInput.addEventListener("change",this.dateChanged.bind(this)),this.dateInput.addEventListener("focusin",()=>{D.play=!1,this.stoppedByFocus=!0}),this.dateInput.addEventListener("focusout",()=>{D.play=this.stoppedByFocus,this.stoppedByFocus=!1}),e.appendChild(this.dateInput),document.body.appendChild(e),this.update()}dateChanged(){this.stoppedByFocus=!1,D.play=!1,D.time=this.dateInput.valueAsNumber}updateDateInputValue(){this.dateInput.value=new Date(D.time).toISOString().slice(0,-3)}update(){this.dateInput.matches(":focus")||this.updateDateInputValue()}}const wt=class extends Ot{constructor(){super(),[{position:new J(wt.distance,0,0),name:"E"},{position:new J(-wt.distance,0,0),name:"W"},{position:new J(0,0,-wt.distance),name:"N"},{position:new J(0,0,wt.distance),name:"S"}].forEach(i=>{this.add(new de(i.position,i.position,100,i.name==="N"?16711935:65535,30,30))});const e=new ue(450);this.add(e)}};let te=wt;te.distance=500;class Ne{constructor(){this.initScene(),this.initStats(),this.initListeners()}initStats(){this.stats=new vt,document.body.appendChild(this.stats.dom)}initScene(){this.scene=new pe,this.camera=new me(75,window.innerWidth/window.innerHeight,.1,1e4),this.camera.position.setFromSphericalCoords(600,Math.PI/4,0),this.renderer=new fe,this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=ge,this.renderer.setPixelRatio(window.devicePixelRatio),this.renderer.setSize(window.innerWidth,window.innerHeight),document.body.appendChild(this.renderer.domElement),this.controls=new De(this.camera,this.renderer.domElement);const e=new be(11184810);this.scene.add(e),this.sun=new Fe,this.scene.add(this.sun),this.constructions=new ht,this.scene.add(this.constructions),this.currentTime=new He,this.scene.add(new te),this.initGui(),this.animate(1)}initGui(){const e=new It,i=e.addFolder("Time");i.add(D,"play").listen(),i.add(D,"timeSpeedMultiplier",0,1e5),e.addFolder("Constructions").add(ht,"nbdetages",1,10,1).onChange(()=>{this.updateConstructions()})}initListeners(){window.addEventListener("resize",this.onWindowResize.bind(this),!1),window.addEventListener("keypress",e=>{const{key:i}=e;switch(i){case"e":this.takeScreenShot(),e.preventDefault(),e.stopPropagation();break;case" ":D.play=!D.play,e.preventDefault(),e.stopPropagation();break;case"ArrowDown":ht.nbdetages-=1,e.preventDefault(),e.stopPropagation();break;case"ArrowUp":ht.nbdetages+=1,e.preventDefault(),e.stopPropagation();break;case"ArrowRight":D.addOneMinute(),e.preventDefault(),e.stopPropagation();break;case"ArrowLeft":D.removeOneMinute(),e.preventDefault(),e.stopPropagation();break;case"h":e.shiftKey?D.removeOneHour():D.addOneHour(),e.preventDefault(),e.stopPropagation();break;case"d":e.shiftKey?D.removeOneDay():D.addOneDay(),e.preventDefault(),e.stopPropagation();break;case"m":e.shiftKey?D.removeOneMonth():D.addOneMonth(),e.preventDefault(),e.stopPropagation();break}})}takeScreenShot(){const{domElement:e}=this.renderer;this.renderer.render(this.scene,this.camera);const i=e.toDataURL();this.download(i,`${new Date(D.time).toISOString()}-${ht.nbdetages}etages.png`)}download(e,i){const t=document.createElement("a");t.href=e,t.download=i,t.click()}onWindowResize(){this.camera.aspect=window.innerWidth/window.innerHeight,this.camera.updateProjectionMatrix(),this.renderer.setSize(window.innerWidth,window.innerHeight)}animate(e){requestAnimationFrame(i=>{this.animate(i)}),D.update(e),this.update(),this.renderer.render(this.scene,this.camera)}updateConstructions(){this.constructions.update()}update(){var e,i;(e=this.stats)==null||e.update(),(i=this.controls)==null||i.update(),this.currentTime.update(),this.sun.updatePosition()}}window.addEventListener("DOMContentLoaded",()=>{new Ne});
